...
public class EvaluationTests
{
    ...
    public void SymmetricalEval_Test()
    {
        ...
        Assert.IsTrue( evaluation.EvaluatePosition( board ) == evaluation.EvaluatePosition( FlipBoard( board ) ) );
        ...
        Assert.AreEqual( evaluation.EvaluatePosition( board ), evaluation.EvaluatePosition( FlipBoard( board ) ) );
